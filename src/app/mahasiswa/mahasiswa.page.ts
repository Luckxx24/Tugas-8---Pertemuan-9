...
export class MahasiswaPage implements OnInit {
  ...
  // Deklarasikan variabel tambahan untuk modal
  modalTambah: any;
  id: any;
  nama: any;
  jurusan: any;
  ...
  constructor(
    ...
    private modal: ModalController  // Tambahkan ModalController pada constructor
  ) { }
  ...
  // Fungsi untuk mereset data pada modal
  resetModal() {
    this.id = null;
    this.nama = '';
    this.jurusan = '';
